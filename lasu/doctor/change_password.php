...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    :root{--purple:#3C3489;--pm:#534AB7;--cream:#FAF8F3;--white:#fff;--border:#D4D2E8;--text:#0D0D1F;--mid:#3D3A60;--muted:#7A78A0;--erb:#FEF2F2;--erb2:#FECACA;--ert:#991B1B;--sb:#E1F5EE;--sb2:#9FE1CB;--st:#085041}
    ...
    .pwwrap input:focus{border-color:var(--pm);box-shadow:0 0 0 3px rgba(83,74,183,.12)}
    ...
    .btn-primary{flex:1;height:48px;background:var(--purple);color:#fff;border:none;border-radius:9px;font-size:14px;font-weight:600;cursor:pointer;font-family:'Plus Jakarta Sans',sans-serif;transition:background .2s}
    .btn-primary:hover{background:var(--pm)}
    .btn-back{height:48px;padding:0 20px;background:transparent;border:1.5px solid var(--border);border-radius:9px;font-size:14px;color:var(--muted);text-decoration:none;display:flex;align-items:center;cursor:pointer}
